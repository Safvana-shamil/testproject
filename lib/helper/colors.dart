...
// Color? mainColor = Colors.lightBlue[400];
...
const Color red = Color(0xFFD91111);
const Color mainColor = Color(0xFF28A7F8);
const Color lightBackground = Color(0xFFF3F4F5);
